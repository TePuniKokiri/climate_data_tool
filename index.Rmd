...
<div style="color:#007C9D;font-size:medium;margin-bottom: 21px;"> <em>
...
accessed via popup windows by clicking on a region or using the navbar at the
top of this page. The climate-based maps for SA2s include various socio-economic
filter layers that can be overlaid on climate information. Similarly, the
socio-economic-based maps can be masked by climate filter layers. Note that a
higher decile number corresponds to a greater risk level in these maps.
...
<div class="col-md-9" id="the_finder"
     style="height:750px;overflow:auto;padding-top:0px;padding-left:14px;padding-right:0px;">
```{r out.width='100%', out.height='762px', echo=FALSE}
